...
'***************************************************************
Function showDetailScreen(screen As Object, showList As Object, showIndex as Integer, isRandom as Boolean) As Integer
        ...
        if type(msg) = "roSpringboardScreenEvent" then
            if msg.isScreenClosed()
                ...
                if msg.GetIndex() = remoteKeyLeft then
                    if isRandom then
                        showIndex = Rnd(showList.Count()) - 1
...
Function refreshShowDetail(screen As Object, showList As Object, showIndex as Integer) As Integer
    ...
    'print "displaying index = " + itostr(showIndex)
    ...
    'screen.AddButton(3, "Next Random")    
    else
